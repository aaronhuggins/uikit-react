...
function Alert(props) {
    ...
    return (React.createElement("div", { id: props.id ? props.id : null, className: _setClassNames(), style: {
        ...
        props.isClosable ? React.createElement("a", { className: "uk-alert-close", "uk-close": true, onClick: handleClose }) : null,
...
function Cover(props) {
    ...
    const renderBasedOnType = () => {
        if (props.type === 'image') {
            return (React.createElement("img", { src: props.src, alt: props.alt, width: props.width, height: props.height, "uk-cover": '' }));
        }
        if (props.type === 'video') {
            return (React.createElement("video", { autoPlay: props.autoPlay, loop: props.loop, muted: props.muted, playsInline: props.playsInline, width: props.width, height: props.height, "uk-cover": '' },
...
function Dropdown(props) {
    return (React.createElement("div", { id: props.id ? props.id : null, className: `${setClassNames(props)}`, "uk-dropdown": props.options ? props.options : '' }, props.children));
}
...
class Form extends React.Component {
    render() {
        return (React.createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), "uk-form-custom": this.props.custom ? '' : null }, this.props.children));
    }
    setClassNames() {
        return classNames$3({
            [`uk-form-${this.props.layout}`]: !!this.props.layout,
...
class Input extends React.Component {
    render() {
        return (React.createElement("input", { id: this.props.id, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), type: "text", name: this.props.name ? this.props.name : null, value: this.props.value, minLength: this.props.minLength, maxLength: this.props.maxLength, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    }
    setClassNames() {
        return classNames$4({
            [`uk-input`]: true,
...
const classNames$6 = _classNames;
class FormLabel extends React.Component {
    render() {
        return (React.createElement("label", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), htmlFor: this.props.htmlFor }, this.props.children));
    }
    setClassNames() {
        return classNames$6({
            [`uk-form-label`]: true,
...
class Radio extends React.Component {
    render() {
        return (React.createElement("input", { id: this.props.id, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), type: "radio", name: this.props.name ? this.props.name : null, checked: this.props.value, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    }
    setClassNames() {
        return classNames$8({
            [`uk-radio`]: true,
...
class Textarea extends React.Component {
    render() {
        return (React.createElement("textarea", { id: this.props.id ? this.props.id : null, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), name: this.props.name ? this.props.name : null, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus, readOnly: this.props.readOnly, disabled: this.props.disabled }, this.props.children));
    }
    setClassNames() {
        return classNames$c({
            [`uk-textarea`]: true,
...
function Icon(props) {
    ...
    const renderIconType = () => {
        if (props.href) {
            return (React.createElement("a", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: getClassNames(), href: props.href, "uk-icon": props.options }));
        }
        if (props.image) {
        ...
        return (React.createElement("em", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: getClassNames(), "uk-icon": props.options }));
    };
    return renderIconType();
}

function Image(props) {
    return (React.createElement("img", { id: props.id ? props.id : null, className: props.className, width: props.width, height: props.height, style: props.style ? props.style : null, "data-src": props.src, "uk-img": props.options ? props.options : '' }));
}
...
function Lightbox(props) {
    return (React.createElement("div", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: setClassNames(props), "uk-lightbox": props.options ? props.options : '' }, props.children));
}
...
function Link(props) {
    ...
    return (React.createElement("a", { id: props.id ? props.id : null, style: props.style ? props.style : null, "uk-toggle": props.toggleOptions ? props.toggleOptions : null, href: props.href, className: `${_setClassNames()}` }, props.children));
}
...
function Margin(props) {
    ...
    return (React.createElement("div", { id: props.id ? props.id : null, style: props.style ? props.style : null, "uk-margin": props.dynamicWrapping, className: _setClassNames() }, props.children));
}
...
function Nav(props) {
    ...
    return (React.createElement("ul", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: `${_setClassNames()}`, "uk-nav": props.options ? props.options : '' }, props.children));
}
...
function NavbarContainer(props) {
    ...
    return (React.createElement("div", null,
        React.createElement("nav", { id: props.id ? props.id : null, className: `${_setClassNames()}`, style: props.style ? props.style : null, "uk-navbar": props.options ? props.options : '' }, props.children),
...
function NavbarSticky(props) {
    ...
    return (React.createElement("div", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: `${setClassNames(props)}`, "uk-sticky": `
...
function Offcanvas(props) {
    ...
    return (React.createElement("div", { id: props.id, style: props.style ? props.style : null, className: `${setClassNames(props)}`, "uk-offcanvas": props.options ? props.options : '' },
...
function Scrollspy(props) {
    return (React.createElement("div", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: `${setClassNames(props)}`, "uk-scrollspy": props.options ? props.options : '' }, props.children));
}
...
function Slideshow(props) {
    ...
    return (React.createElement("div", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: `${setClassNames(props)}`, "uk-slideshow": props.options ? props.options : '' }, setNavigation()));
}
...
function SlideshowItem(props) {
    const renderBasedOnType = () => {
        ...
        if (props.type === 'video') {
            return (React.createElement("video", { autoPlay: props.autoPlay, loop: props.loop, muted: props.muted, playsInline: props.playsInline, "uk-cover": '' },
                React.createElement("source", { src: props.src, type: `${props.type}/${props.videoFormat}` })));
        }
        console.error('Type property on cover component must be either video or image');
    };
...
function TableBody(props) {
    return (React.createElement("tbody", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: `${setClassNames(props)}` }, props.children));
}
...
function TableData(props) {
    ...
    return (React.createElement("td", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: _setClassNames() }, props.children));
}

function TableFoot(props) {
    return (React.createElement("tfoot", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: `${setClassNames(props)}` }, props.children));
}

function TableHead(props) {
    return (React.createElement("thead", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: `${setClassNames(props)}` }, props.children));
}
...
function TableHeader(props) {
    ...
    return (React.createElement("th", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: _setClassNames() }, props.children));
}

function TableRow(props) {
    return (React.createElement("tr", { id: props.id ? props.id : null, style: props.style ? props.style : null, className: `${setClassNames(props)}` }, props.children));
}

export { Accordion, AccordionItem, Alert, Article, Badge, Breadcrumb, Button, Card, CardBody, CardFooter, CardHeader, CardTitle, Container, Cover, Dark, Dropdown, Flex, Checkbox, Fieldset, Form, Input, InputContainer, FormLabel, Legend, Radio, Range, Select, SelectOption, Textarea, Grid, Icon, Image, Label, Light, Lightbox, LightboxItem, Link, List, ListItem, Margin, Nav, NavItem, Navbar, NavbarContainer, NavbarDropdown, NavbarSticky, Offcanvas, OffcanvasContainer, Overlay, Panel, Parallax, Progress, Scrollspy, Section, Sidebar, Slideshow, SlideshowItem, Tab, TabContainer, TabContent, Table, TableBody, TableData, TableFoot, TableHead, TableHeader, TableRow };
